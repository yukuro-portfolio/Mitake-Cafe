           ...
           <div class="top-info__inner">
             <div class="top-info__col">
               <div class="about__capture">
                 <img class="about__img" src="/images/img/img_about-descimg.png" alt="御岳の四季と調和した至福のカフェ">
               </div>
             ...
             <div class="top-menu">
               ...
               <div class="top-menu__box">
                 ...
                 <section class="top-menu__col">
                   ...
                   <figure class="top-menu__figure" data-aos="fade-left">
                     <img class="top-menu__img" src="/images/img/img_menu-sweets_01.jpg" alt="メニュー スイーツ">
                   </figure>
                 </section>

                 <div class="top-menu__col top-menu__col--overlap">
                   <figure class="top-menu__figure top-menu__figure--overlap" data-aos="fade-right">
                     <img class="top-menu__img" src="/images/img/img_menu-sweets_02.jpg" alt="メニューのりんごパイ">
                   </figure>
               ...
               <div class="top-menu__box">
                 ...
                 <section class="top-menu__col">
                   ...
                   <figure class="top-menu__figure" data-aos="fade-left">
                     <img class="top-menu__img" src="/images/img/img_menu-dish_01.jpg" alt="メニュー 料理">
                   </figure>
                 </section>

                 <div class="top-menu__col">
                   <figure class="top-menu__figure top-menu__figure--overlap" data-aos="fade-right">
                     <img class="top-menu__img" src="/images/img/img_menu-dish_02.jpg" alt="メニューの洋風ハンバーグ">
                   </figure>
               ...
               <div class="top-menu__box">
                 ...
                 <section class="top-menu__col">
                   ...
                   <figure class="top-menu__figure" data-aos="fade-left">
                     <img class="top-menu__img" src="/images/img/img_menu-drink_01.jpg" alt="メニュー 飲み物">
                   </figure>
                 ...
                 <div class="top-menu__col">
                   <figure class="top-menu__figure top-menu__figure--overlap" data-aos="fade-right">
                     <img class="top-menu__img" src="/images/img/img_menu-drink_02.jpg" alt="メニューのブレンドコーヒー">
                   </figure>
                   <div class="desc">
                     <p class="desc__text">
               ...
               <section class="mitake__box">
                 ...
                 <div class="mitake__wrapper">
                   <figure class="mitake__figure" data-aos="fade-right">
                     <img class="mitake__img" src="/images/img/img_mitake-keikoku.jpg" alt="御岳渓谷">
                   </figure>
                   <div class="desc fade-in js-fade-in-left">
                     <p class="desc__text">
               ...
               <section class="mitake__box">
                 ...
                 <div class="mitake__wrapper mitake__wrapper--row-reverse">
                   ...
                   <figure class="mitake__figure" data-aos="fade-left">
                     <img class="mitake__img" src="/images/img/img_mitake-mt.mitake.jpg" alt="御岳渓谷">
                   </figure>
                 </div>
               </section>
               <!-- ===== 御岳山 End ===== -->
